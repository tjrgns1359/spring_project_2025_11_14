...
//CRUD CREATE에 해당하는 기능중하나
	@Insert("INSERT INTO backend_spring_project.user(username,password,writer,role, postcode, address1, address2, phone)"
			+ "VALUES(#{username},#{password},#{writer},#{role},#{postcode},#{address1},#{address2}, #{phone})")
	void insertUser(User user);
	//void => DB에 넣기만 하면 되니깐 반환할 필요없어서 void 사용
