		...
		<form id="menuForm">
			<div id=container>
				<div id="menuAdmin">
					...
					<input type="text" id="title" name="title" placeholder="제목" maxlength="20" value="${menu.title}" >
					<br>
					<label for="title">내용</label>
					<input type="text" id="content" name="content" placeholder="내용" maxlength="50" value="${menu.content}" >
					<br>
